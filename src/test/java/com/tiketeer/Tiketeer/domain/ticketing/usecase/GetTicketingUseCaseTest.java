...
@SpringBootTest
@DisplayName("GetTicketingUseCaseTest Test")
class GetTicketingUseCaseTest {
	...
	@Autowired
	private GetTicketingUseCase getTicketingUseCase;
	...
	void getTicketingSuccess() {
		...
		// when
		var result = getTicketingUseCase.getTicketing(command);
